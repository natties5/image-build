...
LEGACY_MIRROR_BASE_URL="http://mirrors.openlandscape.cloud"
...
# =========================
# Enable vault fallback when LEGACY_MIRROR fails or official degrades
...
# LEGACY_MIRROR path for this version
LEGACY_MIRROR_REPO_PATH="/ubuntu"
...
```json
{
  ...
  "repo_mode_used": "ols",
  "repo_mode_reason": "legacy_mirror_ok",
  "official_degraded": false,
  "legacy_mirror_attempted": true,
  "legacy_mirror_reachable": true,
...
* `LEGACY_MIRROR_BASE_URL`
* `LEGACY_MIRROR_REPO_PATH`
* `APT_SOURCE_MODE`
...
* `LEGACY_MIRROR_FAILOVER_TO_OFFICIAL`
